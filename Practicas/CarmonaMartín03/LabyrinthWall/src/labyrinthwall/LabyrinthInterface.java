...
public class LabyrinthInterface extends PApplet {
    ...
    int lwHeight = height*pixelss;  
    int lwwidth = width*pixelss;    
    ...
    public void setup(){
        background(255);                       
        mazze = new LabyrinthWall(width,height); 
        path  = new Stack<>();                 
        mazze.matrix[xInit][yInit].visitada = true; 
        path.push(mazze.matrix[xInit][yInit]);      
    }
